...
export function SettingsPageContent({ initialData, isDemo: propIsDemo }: SettingsPageContentProps) {
  ...
  return (
    <div className="space-y-4 animate-fade-in">
      ...
      {/* ============================================================ */}
      {/* FOOTER: LEGAL & OPEN SOURCE                                  */}
      {/* ============================================================ */}
      <div className="pt-8 mt-4 space-y-6" style={{ borderTop: '1px solid var(--border)' }}>
        {/* Terms & Privacy Links */}
        <div className="flex items-center justify-center gap-4 text-sm">
          ...
          >
            {language === 'nb' ? 'Vilkår' : language === 'sv' ? 'Villkor' : 'Terms'}
          </a>
          ...
          <a
            ...
            style={{ color: 'var(--muted)' }}
          >
            {language === 'nb' ? 'Personvern' : language === 'sv' ? 'Integritet' : 'Privacy'}
          </a>
        </div>
        ...
        <div className="text-center space-y-3">
          <div className="flex items-center justify-center gap-2">
            ...
            <span className="text-sm font-medium" style={{ color: 'var(--foreground)' }}>
              {language === 'nb' ? 'Åpen kildekode' : language === 'sv' ? 'Öppen källkod' : 'Open Source'}
            </span>
          </div>
          <p className="text-sm" style={{ color: 'var(--muted)' }}>
            {language === 'nb'
              ? 'Familjen er åpen kildekode og 100% AI-drevet. Bidra gjerne til å gjøre appen bedre for alle!'
              : language === 'sv'
              ? 'Familjen är öppen källkod och 100% AI-driven. Bidra gärna till att göra appen bättre för alla!'
              : 'Familjen is open source and 100% AI-driven. Contribute to make it better for everyone!'}
          </p>
          <a
            href="https://github.com/n0rpan/familjen"
            target="_blank"
          ...
          >
            ...
            {language === 'nb' ? 'Se koden på GitHub' : language === 'sv' ? 'Se koden på GitHub' : 'View on GitHub'}
          </a>
        </div>
      </div>
    </div>
